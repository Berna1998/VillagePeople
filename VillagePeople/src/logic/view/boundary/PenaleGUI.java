...
public class PenaleGUI implements Subject {
	...
	public PenaleGUI() {
		...
		framePenale = new JFrame();
		framePenale.setBounds(100, 100, 517, 700);
		framePenale.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
		
		JPanel panelPenale = new JPanel();
		panelPenale.setBackground(new Color(255, 160, 122));
		framePenale.getContentPane().add(panelPenale, BorderLayout.CENTER);
		panelPenale.setLayout(null);
		...
		panelPenale.add(textPaneCodicePenale);
		...
		panelPenale.add(labelCostoPenale);
		...
		panelPenale.add(textPaneCodiceAtt);
		...
		panelPenale.add(lblNewLabel081);
		...
		panelPenale.add(txtPcodiceUtente);
		...
		panelPenale.add(lblNewLabel992);
