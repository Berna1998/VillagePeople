...
<%
	...
	try {
		totale1 = mac.prendiElenco(1, connessione);
...
<html lang="en">
  ...
  <body style="background-color: â€#CCCCCCâ"€>
    ...
    <h1> </h1>
    <form action="ElencoIntolleranze1.jsp" name="formElencInt" method="POST">
    <input type="hidden" id="custIdElenInt1" name="custIdElenInt1" value="<%=codice%>">
    <div class="container">
      <div class="row">
        <div class="col-sm">
        ...
        <div class="col-sm">
          <div class="card" style="width: 40rem;">
            <div class="card-body">
              <h3 class="card-title" style="text-align:center">Intolleranze menu 1</h3>
              <h1><label for="intolleranze"><%=totale1%></label> </h1>
