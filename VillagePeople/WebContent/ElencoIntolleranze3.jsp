...
<%
	...
	try {
		totale3 = mac.prendiElenco(3, connessione);
...
<html lang="en">
  ...
  <body style="background-color: â€#CCCCCCâ">
    ...
    <h1> </h1>
    <form action="ElencoIntolleranze3.jsp" name="formElencInt3" method="POST">
 	<input type="hidden" id="custIdElenInt3" name="custIdElenInt3" value="<%=codice%>">   
    <div class="container">
      <div class="row">
        <div class="col-sm">
        ...
        <div class="col-sm">
          <div class="card" style="width: 40rem;">
            <div class="card-body">
              <h3 class="card-title" style="text-align:center">Intolleranze menu 3</h3>
              <h1><label for="intolleranze"><%=totale3%></label> </h1>
